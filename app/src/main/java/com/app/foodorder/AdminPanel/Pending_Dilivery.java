...
public class Pending_Dilivery extends AppCompatActivity {
    RecyclerView rv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pending_dilivery);
        rv = findViewById(R.id.recyclerViewdilivery);
        ArrayList<PlaceOrderModel> list = new ArrayList<>();
        ActiveOrderAdapter adapter = new ActiveOrderAdapter(list, 1);
